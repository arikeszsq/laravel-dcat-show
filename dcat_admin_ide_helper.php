...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection actors
     ...
     * @method Grid\Column|Collection actors(string $label = null)
     ...
     * @property Show\Field|Collection actors
     ...
     * @method Show\Field|Collection actors(string $label = null)
